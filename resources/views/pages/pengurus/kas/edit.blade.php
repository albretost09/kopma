        ...
        <div class="content ">
                ...
                <div>
                    ...
                    <nav aria-label="breadcrumb" class="d-flex align-items-start">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Ubah Kas</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-12">
                            <form action="{{ route('pengurus.kas.update', $kas->id) }}" method="post">
                                @method('PUT')
                                @csrf
                                <div class="card">
                                    <div class="card-body">
                                        <h6 class="card-title">Ubah Kas</h6>
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" name="no_cek" value="{{ $kas->no_cek }}"
                                                            class="form-control">
                                                    </div>
                                                </div>
                                            </div>
